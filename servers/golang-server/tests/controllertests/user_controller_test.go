...
func TestCreateUser(t *testing.T) {
	...
	samples := []struct {
		...
		{
			inputJSON:    `{"firstname":"Pet", "lastname":"Petson","diveclub_id":1,"email": "pet@gmail.com", "password": "password"}`,
			statusCode:   201,
			firstname:    "Pet",
			lastname:     "Petson",
			email:        "pet@gmail.com",
		...
		{
			inputJSON:    `{"firstname":"Pet", "lastname":"Petson","diveclub_id":1,"email": "bad_email.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "invalid email",
		},
		{
			inputJSON:    `{"firstname":"Pet", "lastname":"Petson", "diveclub_id":1, "password": "password"}`,
			statusCode:   422,
...
func TestUpdateUser(t *testing.T) {
	...
	samples := []struct {
	...
	}{
		{
			...
			updateJSON:       `{"firstname":"Grand", "email": "grand@gmail.com", "password": "password"}`,
			statusCode:       200,
			updatedFirstname: "Grand",
		...
		},
		{
			...
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"firstname":"Woman", "email": "woman@gmail.com", "password": ""}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "required password",
		},
		...
		},
		{
			...
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"firstname":"Woman", "email": "woman@gmail.com", "password": "password"}`,
			statusCode:   401,
		...
		},
		{
			...
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"firstname":"Frank", "email": "kenny@gmail.com", "password": "password"}`,
			statusCode:   500,
			tokenGiven:   tokenString,
			errorMessage: "email already registered",
		},
		{
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"firstname":"Kan", "email": "kangmail.com", "password": "password"}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "invalid email",
		},
		{
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"firstname": "Kan", "email": "", "password": "password"}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "required email",
		},
		...
		},
		{
			...
			updateJSON:   `{"firstname": "Mike", "email": "mike@gmail.com", "password": "password"}`,
			tokenGiven:   tokenString,
			statusCode:   401,
			errorMessage: "Unauthorized",
		},
	...
	for _, v := range samples {
		...
		assert.Equal(t, rr.Code, v.statusCode)
		if v.statusCode == 200 {
			assert.Equal(t, responseMap["firstname"], v.updatedFirstname)
